...
export function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeInUp} className="relative flex items-center gap-3">
      ...
      <motion.div variants={fadeInUp} className="grid grid-cols-2 gap-3">
        <a
          href={`${import.meta.env.VITE_API_URL ?? 'http://localhost:8080/api/v1'}/auth/google`}
          className="flex items-center justify-center gap-2 rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent transition-colors"
        >
        ...
        <a
          href={`${import.meta.env.VITE_API_URL ?? 'http://localhost:8080/api/v1'}/auth/github`}
          className="flex items-center justify-center gap-2 rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent transition-colors"
        >
