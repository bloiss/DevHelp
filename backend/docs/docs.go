...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "DevHelp Team",
            "url": "https://github.com/bloiss/DevHelp"
        },
        "license": {
            "name": "MIT",
    ...
    "paths": {
        "/api/v1/admin/posts": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filtrer par statut (published, pending, rejected, hidden)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.PostListResult"
                        }
                    },
                    "401": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.postStatusRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.UserListResult"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/api/v1/auth/github/callback": {
            "get": {
                ...
                "responses": {
                    "307": {
                        "description": "Redirect to /auth/login?error=oauth_failed",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/api/v1/auth/reset-password": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Token + nouveau mot de passe",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.categoryWriteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/conversations": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "user_id: UUID de l'interlocuteur",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/conversations/{id}/accept": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/conversations/{id}/messages": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Curseur de pagination (RFC3339 timestamp)",
                        "name": "before",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Contenu du message (content, attachment_url, attachment_type, shared_post_id)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/notifications/prefs": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "description": "Préférences (push_enabled, notify_on_comment, notify_on_like, notify_on_message)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/notifications/{id}/archive": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "archived: true/false",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/notifications/{id}/star": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "starred: true/false",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/posts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "UUID auteur",
                        "name": "author_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Username auteur",
                        "name": "author",
                        "in": "query"
                    },
                    {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.VoteResult"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/v1/push/subscriptions": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Subscription (endpoint, p256dh, auth)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/service.PublicProfile"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/api/v1/users/{username}/follow": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username de l'utilisateur à suivre",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Username de l'utilisateur à ne plus suivre",
                        "name": "username",
                        "in": "path",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "handler.postStatusRequest": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/model.ContentStatus"
                }
            }
        },
        ...
        "model.Comment": {
            ...
            "properties": {
                ...
                "vote_count": {
                    "description": "Champs calculés (non stockés en DB)",
                    "type": "integer"
                }
            }
        },
        ...
        "model.Post": {
            ...
            "properties": {
                ...
                "images": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.PostImage"
                    }
                },
                "is_hidden": {
                    "type": "boolean"
